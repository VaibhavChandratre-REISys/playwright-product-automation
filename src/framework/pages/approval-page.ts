...
export class ApprovalPage extends BasePage {
  private readonly container = '//c-approval-decision';
  ...
  async clickToastActionIfPresent(): Promise<void> {
    try {
  ...
  async selectRadioButton(optionName: string): Promise<void> {
  ...
  private async areRadioButtonsVisible(): Promise<boolean> {
  ...
  async submitApproval(withProcessing: boolean = true): Promise<void> {
  ...
  async isRadioButtonVisible(name: string): Promise<boolean> {
  ...
  async isUserPresentInLookup(user: string): Promise<boolean> {
  ...
  async getApprovalOptions(): Promise<string[]> {
  ...
  async getApprovalMessages(): Promise<string[]> {
  ...
  /** Click submit confirmation if present (mirrors Selenium: submitConfirmationLocator) */
  async clickSubmitConfirmationIfPresent(): Promise<void> {
    try {
