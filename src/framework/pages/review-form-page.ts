...
export class ReviewFormPage {
   ...
   */
  async completeFillingReviewForm(recommendation: string): Promise<void> {
    ...
    try {
      ...
      if (await conflictOfInterest.count() > 0) {
        ...
        try {
          ...
          await conflictOfInterest.evaluate((el: any) => el.click());
        }
   ...
   * Get all form section titles
   */
  private async getFormSectionTitles(): Promise<string[]> {
   ...
   */
  private async getRowCountForSection(title: string): Promise<number> {
   ...
   */
  private async fillTextAreaFields(title: string, rowIndex: number): Promise<void> {
   ...
   */
  private async fillInputFields(title: string, rowIndex: number): Promise<void> {
   ...
   */
  private async fillScoreFields(title: string, rowIndex: number): Promise<void> {
   ...
   */
  private async fillDropdownFields(title: string, rowIndex: number): Promise<void> {
   ...
   */
  private async fillPercentFields(title: string, rowIndex: number): Promise<void> {
   ...
   * Fill dollar fields
   */
  private async fillDollarFields(title: string, rowIndex: number): Promise<void> {
   ...
   * Fill date fields
   */
  private async fillDateFields(title: string, rowIndex: number): Promise<void> {
