...
export class ModalPage extends BasePage {
   ...
   */
  async clickModalButton(buttonName) {
   ...
   */
  async closeModalByTitle(titleName) {
   ...
   */
  async clickConfirmationButton(buttonName) {
    const resolved = this.resolve(buttonName);
   ...
   *   | ...//a[text()='Y']
   */
  async assertModalField(field, text) {
   ...
   */
  async enterModalFieldValue(fieldApiName, fieldValue) {
