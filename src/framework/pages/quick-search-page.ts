...
export class QuickSearchPage extends BasePage {
   ...
   */
  async performQuickSearch(tableId: string, searchTerm: string): Promise<void> {
   ...
   */
  private async waitForTableWithScroll(
   ...
   */
  async performGlobalQuickSearch(searchTerm: string): Promise<void> {
