...
export class NavigationPage extends BasePage {
   ...
   */
  async clickMainTab(tabName: string): Promise<void> {
   ...
   */
  async clickSidebarContent(subHeader: string, contentName: string): Promise<void> {
   ...
   */
  async clickSubTab(subTabName: string): Promise<void> {
