...
export class WindowHandler {
   ...
   __init() {this.initialPages = []}

  constructor(page, context) {;WindowHandler.prototype.__init.call(this);
    this.page = page;
   ...
   */
  async switchToWindowByIndex(handlerNumber) {
   ...
   */
  async closeCurrentAndSwitchToPrevious() {
    const pages = this.context.pages();
   ...
   */
  async executeWithWindowDetection(action) {
