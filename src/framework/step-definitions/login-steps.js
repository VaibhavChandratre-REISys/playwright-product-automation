...
function resolveBaseUrl(portalOrApp, config) {
 ...
 */
const portalHandler = async function ( portal) {
  const config = getConfig();
...
const enterUsernameHandler = async function ( value) {
...
const selectUserDropdownHandler = async function ( value) {
  const resolved = this.savedValues.resolve(value);
