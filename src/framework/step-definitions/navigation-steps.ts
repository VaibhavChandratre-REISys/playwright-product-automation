...
When(
  ...
  async function (this: CustomWorld, content: string, subHeader: string) {
    const nav = new NavigationPage(this.page, this.savedValues);
...
When(
  ...
  async function (this: CustomWorld, content: string, subHeader: string, tabName: string) {
    const nav = new NavigationPage(this.page, this.savedValues);
    await nav.clickMainTab(tabName);
    await nav.clickSidebarContent(subHeader, content);
  }
...
When(
  ...
  async function (this: CustomWorld, subTabName: string) {
    const nav = new NavigationPage(this.page, this.savedValues);
...
When(
  ...
  async function (this: CustomWorld, iconName: string, uniqueValue: string) {
...
When(
  ...
  async function (this: CustomWorld, iconName: string, uniqueValue: string, tableId: string) {
    const ft = new FlexTablePage(this.page, this.savedValues);
...
When(
  ...
  async function (this: CustomWorld, buttonName: string, tableId: string) {
    const ft = new FlexTablePage(this.page, this.savedValues);
...
When(
  ...
  async function (this: CustomWorld, titleName: string) {
    const modal = new ModalPage(this.page, this.savedValues);
...
When(
  ...
  async function (this: CustomWorld, usage: string, fieldValue: string, fieldApiName: string) {
    const pd = new PageDetailsPage(this.page, this.savedValues);
...
When(
  ...
  async function (this: CustomWorld, fieldValue: string, fieldApiName: string) {
    const pd = new PageDetailsPage(this.page, this.savedValues);
...
When(
  ...
  { timeout: 300000 },
  async function (this: CustomWorld, usage: string, sheetName: string, fileName: string) {
    const pd = new PageDetailsPage(this.page, this.savedValues);
...
When(
  ...
  async function (this: CustomWorld, uniqueText: string, tableId: string) {
    const ft = new FlexTablePage(this.page, this.savedValues);
...
When(
  ...
  async function (this: CustomWorld, tableId: string, buttonName: string, dataTable: any) {
...
When(
  ...
  async function (this: CustomWorld, tableId: string, editButtonName: string, dataTable: any) {
    const ft = new FlexTablePage(this.page, this.savedValues);
    const rawRows: string[][] = dataTable.raw();
...
When(
  ...
  async function (this: CustomWorld, recordUniqueValues: string, tableId: string, buttonName: string) {
    const ft = new FlexTablePage(this.page, this.savedValues);
...
When(
  ...
  async function (this: CustomWorld, columnValue: string) {
    ...
    if (await collapseBtn.count() > 0) {
      const iconName = await collapseBtn.getAttribute('icon-name') ?? '';
...
When(
  ...
  async function (this: CustomWorld, columnName: string, tableId: string) {
    const ft = new FlexTablePage(this.page, this.savedValues);
    const resolvedId = ft.resolveTableId(tableId);
...
When(
  ...
  async function (this: CustomWorld, action: string, selection: string, tableId: string) {
    const ft = new FlexTablePage(this.page, this.savedValues);
    const resolvedId = ft.resolveTableId(tableId);
...
When(
  ...
  async function (this: CustomWorld, action: string, selection: string, entries: string, tableId: string) {
    const ft = new FlexTablePage(this.page, this.savedValues);
    const resolvedId = ft.resolveTableId(tableId);
    const resolvedAction = this.savedValues.resolve(action);
    const resolvedSelection = this.savedValues.resolve(selection);
    ...
    } catch { /* entries dropdown may not exist — expected */ }
...
When(
  ...
  async function (this: CustomWorld, direction: string, tableId: string) {
    const ft = new FlexTablePage(this.page, this.savedValues);
    const resolvedId = ft.resolveTableId(tableId);
...
When(
  ...
  async function (this: CustomWorld, fileName: string, fileType: string) {
...
When(
  ...
  async function (this: CustomWorld, tableId: string, numberOfEntries: string) {
    const ft = new FlexTablePage(this.page, this.savedValues);
...
When(
  ...
  async function (this: CustomWorld, tableId: string, key: string) {
    const ft = new FlexTablePage(this.page, this.savedValues);
    const resolvedId = ft.resolveTableId(tableId);
...
When(
  ...
  async function (this: CustomWorld, row: string, colName: string, key: string, tableId: string) {
    const ft = new FlexTablePage(this.page, this.savedValues);
    const resolvedId = ft.resolveTableId(tableId);
...
When(
  ...
  async function (this: CustomWorld, _colName: string, key: string, tableId: string) {
    const ft = new FlexTablePage(this.page, this.savedValues);
    const resolvedId = ft.resolveTableId(tableId);
...
When(
  ...
  async function (this: CustomWorld, fieldValue: string) {
...
When(
  ...
  async function (this: CustomWorld, usage: string, fieldKey: string) {
...
When(
  ...
  async function (this: CustomWorld, menuItemName: string, panelTitleName: string) {
...
When(
  ...
  async function (this: CustomWorld, dataTargetValue: string) {
...
When(
  ...
  async function (this: CustomWorld, panelTitleName: string) {
...
When(
  ...
  async function (this: CustomWorld, usage: string, flexTableTitle: string) {
...
When(
  ...
  async function (this: CustomWorld) {
    ...
    } catch { /* result may appear differently */ }
  }
);
...
When(
  ...
  async function (this: CustomWorld, recommendation: string) {
...
When(
  ...
  async function (this: CustomWorld, rating: string) {
    ...
    await ratingButton.evaluate((el: any) => el.click()).catch(() => {});
    await this.page.waitForTimeout(300);
    
    // Click the rating option
    const ratingOption = this.page.locator(`//span[@title='${resolved}']`).first();
    await ratingOption.evaluate((el: any) => el.click()).catch(() => {});
    await this.page.waitForTimeout(300);
    ...
    if (await commentsTextarea.count() > 0) {
      await commentsTextarea.evaluate((el: any) => el.click()).catch(() => {});
      await this.page.waitForTimeout(200);
...
When(
  ...
  async function (this: CustomWorld, comments: string, buttonName: string) {
...
When(
  ...
  async function (this: CustomWorld, lookupFieldName: string, usage: string) {
...
When(
  ...
  async function (this: CustomWorld, _usage: string, fieldValue: string, fieldApiName: string) {
...
When(
  ...
  async function (this: CustomWorld, searchValue: string) {
...
When(
  ...
  async function (this: CustomWorld, folderName: string) {
...
When(
  ...
  async function (this: CustomWorld, icon: string, modalTitle: string) {
...
When(
  ...
  async function (this: CustomWorld, displayTextOrURL: string, value: string) {
...
When(
  ...
  async function (this: CustomWorld, footerLink: string) {
...
When(
  ...
  async function (this: CustomWorld, check: string, _usage: string, linkName: string) {
    const resolved = this.savedValues.resolve(linkName);
...
When(
  ...
  async function (this: CustomWorld, options: string) {
...
When(
  ...
  async function (this: CustomWorld, value: string, sharingType: string) {
    const resolved = this.savedValues.resolve(value);
    const textarea = this.page.locator(
...
When(
  ...
  async function (this: CustomWorld, actionName: string, _chooseAction: string, _comment: string) {
...
When(
  ...
  async function (this: CustomWorld, fieldName: string, dataTable: any) {
...
When(
  ...
  async function (this: CustomWorld, usage: string, numberOfChar: string, fieldApi: string) {
...
When(
  ...
  async function (this: CustomWorld, operation: string, pageBlock: string, dataTable: any) {
...
When(
  ...
  async function (this: CustomWorld, dropDownValue: string) {
...
When(
  ...
  async function (this: CustomWorld, recordName: string) {
...
When(
  ...
  async function (this: CustomWorld, buttonName: string, uniqueColumnValue: string, tableId: string) {
...
When(
  ...
  async function (this: CustomWorld, usage: string, searchValue: string, labelName: string) {
...
When(
  ...
  async function (this: CustomWorld, lookupLink: string) {
...
When(
  ...
  async function (this: CustomWorld, subMenu: string, mainMenu: string) {
...
When(
  ...
  async function (this: CustomWorld, recordId: string) {
...
When(
  ...
  async function (this: CustomWorld, emailId: string, fieldAPIName: string) {
...
When(
  ...
  async function (this: CustomWorld, tableId: string) {
    const ft = new FlexTablePage(this.page, this.savedValues);
    const resolvedId = ft.resolveTableId(tableId);
...
When(
  ...
  async function (this: CustomWorld, selectOption: string, tableId: string) {
...
When(
  ...
  async function (this: CustomWorld, stickyTitle: string, icon: string) {
...
When(
  ...
  async function (this: CustomWorld, usage: string, itemName: string) {
...
When(
  ...
  async function (this: CustomWorld, flexTableId: string, iconName: string, uniqueColumnValues: string) {
    const ft = new FlexTablePage(this.page, this.savedValues);
...
When(
  ...
  async function (this: CustomWorld, linkText: string, tableId: string) {
    const ft = new FlexTablePage(this.page, this.savedValues);
    const resolvedId = ft.resolveTableId(tableId);
...
When(
  ...
  async function (this: CustomWorld, usage: string, sideBarCategory: string, subHeader: string) {
...
When(
  ...
  async function (this: CustomWorld, blockTitle: string, _blockName: string) {
...
When(
  ...
  async function (this: CustomWorld, blockTitle: string) {
    const resolved = this.savedValues.resolve(blockTitle);
    const helpIcon = this.page.locator(
      `//*[text()='${resolved}']/..//lightning-helptext//button`
    ).first();
...
When(
  ...
  async function (this: CustomWorld, columnTitle: string) {
...
When(
  ...
  async function (this: CustomWorld, tableId: string, column: string) {
    const ft = new FlexTablePage(this.page, this.savedValues);
    const resolvedId = ft.resolveTableId(tableId);
...
When(
  ...
  async function (this: CustomWorld, attachmentName: string) {
...
When(
  ...
  async function (this: CustomWorld, usage: string, radioButton: string, fieldApiName: string) {
...
When(
  ...
  async function (this: CustomWorld, iconName: string, recordName: string) {
    const ft = new FlexTablePage(this.page, this.savedValues);
...
const clickLinkHandler = async function (this: CustomWorld, linkName: string) {
  const resolved = this.savedValues.resolve(linkName);
  const link = this.page.locator(
...
const clickLookupLinkHandler = async function (this: CustomWorld, lookupName: string) {
...
const clickButtonInModalHandler = async function (this: CustomWorld, buttonName: string) {
  const resolved = this.savedValues.resolve(buttonName);
  const modal = new ModalPage(this.page, this.savedValues);
...
When(
  ...
  async function (this: CustomWorld, buttonName: string, buttonLocation: string) {
    const resolved = this.savedValues.resolve(buttonName);
...
const clickGlobalSearchLeftNavHandler = async function (this: CustomWorld, buttonName: string) {
  const resolved = this.savedValues.resolve(buttonName);
  const btn = this.page.locator(
...
When(
  ...
  async function (this: CustomWorld, panelTitle: string) {
...
When(
  ...
  async function (this: CustomWorld, value: string, tableId: string) {
    const ft = new FlexTablePage(this.page, this.savedValues);
    const resolvedId = ft.resolveTableId(tableId);
    const resolved = this.savedValues.resolve(value);
    const link = this.page.locator(
...
When(
  ...
  async function (this: CustomWorld, radioLabel: string) {
...
When(
  ...
  async function (this: CustomWorld, fieldApiName: string) {
...
When(
  ...
  async function (this: CustomWorld, action: string, value: string) {
    const resolved = this.savedValues.resolve(value);
    const header = this.page.locator(
...
const navLeftSideLinkHandler = async function (this: CustomWorld, content: string, subheader: string) {
...
When(
  ...
  async function (this: CustomWorld, iframeId: string) {
...
const enterReassignLookupHandler = async function (this: CustomWorld, value: string) {
  const resolved = this.savedValues.resolve(value);
  const input = this.page.locator(
...
When(
  ...
  async function (this: CustomWorld, value: string, fieldLabel: string) {
    const resolvedValue = this.savedValues.resolve(value);
...
const enterUniqueValueHandler = async function (this: CustomWorld, fieldApiName: string) {
  const resolved = this.savedValues.resolve(fieldApiName);
...
const enterUniqueValueInColumnHandler = async function (this: CustomWorld, colApiName: string, tableId: string) {
...
const enterUniqueYearHandler = async function (this: CustomWorld, fieldApiName: string) {
  const resolved = this.savedValues.resolve(fieldApiName);
...
const selectDropdownValueHandler = async function (this: CustomWorld, value: string, fieldApiName: string) {
  const resolvedValue = this.savedValues.resolve(value);
  const resolvedField = this.savedValues.resolve(fieldApiName);
  const dropdown = this.page.locator(
...
const selectUserValueHandler = async function (this: CustomWorld, value: string, fieldApiName: string) {
  const resolvedValue = this.savedValues.resolve(value);
  const resolvedField = this.savedValues.resolve(fieldApiName);
  const input = this.page.locator(
    `//c-fieldlwc[@data-fieldapiname='${resolvedField}']//input | ` +
...
const selectGlobalSearchDropdownHandler = async function (this: CustomWorld, value: string) {
  const resolved = this.savedValues.resolve(value);
  const dropdown = this.page.locator(
...
const quickSearchGlobalHandler = async function (this: CustomWorld, searchValue: string) {
  const resolved = this.savedValues.resolve(searchValue);
  const qs = new QuickSearchPage(this.page, this.savedValues);
...
When(
  ...
  async function (this: CustomWorld, rowValue: string, colName: string, saveAs: string, tableId: string) {
    const ft = new FlexTablePage(this.page, this.savedValues);
    const resolvedId = ft.resolveTableId(tableId);
...
const getValueFromRowHandler = async function (this: CustomWorld, rowValue: string, colName: string, tableId: string) {
  const ft = new FlexTablePage(this.page, this.savedValues);
  const resolvedId = ft.resolveTableId(tableId);
  const resolvedRow = this.savedValues.resolve(rowValue);
  const resolvedCol = this.savedValues.resolve(colName);
...
When(
  ...
  async function (this: CustomWorld, fieldLabel: string, subTab: string) {
    const resolvedField = this.savedValues.resolve(fieldLabel);
...
const getUpdatedBudgetEndDateHandler = async function (this: CustomWorld, offset: string, award: string) {
...
const advanceFilterHandler = async function (this: CustomWorld, tableId: string, dataTable: any) {
  const ft = new FlexTablePage(this.page, this.savedValues);
  const resolvedId = ft.resolveTableId(tableId);
  const rows = dataTable.hashes();
  for (const row of rows) {
    ...
    if (fieldName && value) {
      const resolvedValue = this.savedValues.resolve(value as string);
      const input = this.page.locator(
...
When(
  ...
  async function (this: CustomWorld, saveAs: string) {
...
const clickMailSubjectHandler = async function (this: CustomWorld, subject: string) {
