...
Given(
  ...
  async function ( programName, properties) {
...
Given(
  ...
  async function ( type, name, props) {
...
Given(
  ...
  async function ( type, name, program, props) {
    const resolvedProps = this.savedValues.resolve(props);
...
Given(
  ...
  async function ( registrationType, role) {
...
Given(/^I created approved FDM on application "([^"]*)"$/, async function ( app) {
  await createdApprovedFDMHandler.call(this, app);
});

Given(/^I created approved FDM on application "([^"]*)" with properties "([^"]*)"$/, async function ( app, props) {
  await createdApprovedFDMHandler.call(this, app, props);
});

Given(/^I created approved FDM on application "([^"]*)" for Lump Sum Type$/, async function ( app) {
...
Given(
  ...
  async function ( announcement, properties) {
...
Given(/^I activated standalone subaward "([^"]*)" with properties "([^"]*)"$/, async function ( name, props) {
...
Given(
  ...
  async function ( application, announcement, properties) {
...
When(
  ...
  async function ( recordName, awardName, apiName) {
...
const deleteRecordHandler = async function ( recordName, objectName) {
  const resolvedRecord = this.savedValues.resolve(recordName);
