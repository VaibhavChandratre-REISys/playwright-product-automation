@GranteeFederalOrganization @GranteePreAwardRegression
Feature: Validate all scenarios for Federal Organization
  ...
  @482153 @ValidateEXEprofileusershouldseeallfieldsandsectiononfederalOrglayout @EXE_Grantee @P2_Grantee @Gregression2
  Scenario Outline: Validate EXE profile user should see all fields and section on federal Org layout
    When I login to "Grantee" app as "<userType>" user
    When I navigate to "Home" tab
    And I navigate to "External" content inside "Organizations" subheader on left panel
    And I click on advance filter of table id "---grantee_tableId:-:fedOrgTableId---" for LWC
  ...
  @477524 @ValidatePOusershouldseeallfieldsandsectiononfederalOrg @P1_Grantee @PO_Grantee @GRegression1
  Scenario Outline: Validate PO user should see all fields and section on federal Org
    When I login to "Grantee" app as "<userType>" user
    When I navigate to "Home" tab
    And I navigate to "External" content inside "Organizations" subheader on left panel
    And I click on advance filter of table id "---grantee_tableId:-:fedOrgTableId---" for LWC
