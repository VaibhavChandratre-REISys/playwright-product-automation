@grantsAwardWB @grantor-regression @grantor-parallel-regression @grantAndAward @AwardExecution
Feature: Validate all scenarios of grants and award without background
  ...
  @68138 @takeSnapShotHistory @snapExecution
...
#    When I enter value "<grantType>" into field "GrantType__c"
  ...
  @64415 @64416 @64417 @64418 @64420 @64421 @64422 @64419 @ErrorMsgTest
  Scenario: Verify validation message is displayed when award owner did not enter Grant Title field while creating direct grant.
    ...
    Then I softly see the following messages in the page details contains:
      ...
      | To Save, Budget Category Type is required.      |
      | To Save, Subrecipient Organization is required. |
      | To Save, Internal Program is required.          |
  ...
  Scenario: Verify If you select Subrecipient Match Required setting as Yes and award owner did not enter Required Match % field then it should show validation message.
    ...
    And I enter "Grant_Creation" values from "Award_Field_Values.xlsx"
    And I click modal button "Continue"
    And I enter "Grant_ED_match_blank" values from "Award_Field_Values.xlsx"
    And I click modal button "Save and Continue"
    And I wait for "2" seconds
  ...
  Scenario Outline: To verify that the Sub Award budget field is editable in the Subrecipient (SPI User) under budget tab
    ...
    When I close "Subaward Line Items" modal by clicking the top right x button
    When I navigate to "Performance" sub tab
    And I edit the following rows inline in flex table with id "---subAwardStandAlone:-:kpiTableId---" by clicking "Edit" :
      | EGMS ID                  | Target |
      | Automation Permanent KPI | 10     |
  ...
  @66224 @66210 @67895 @validateSourceNdInstructionField @ErrorMsgTest
  ...
  | @67895 Validate BP number from subaward is updating the BP number on Grant upon activation of Subaward
    ...
    When I click on "Save" in the page details
    Then I softly see the following messages in the page details contains:
      | To Save, Source is required in the Overview tab under the Plan section. |

  @66223 @67954 @67925 @67916 @67917 @ErrorMsgForPurposeField @ErrorMsgTest
...
#    And I softly see "Automation ADMIN" is present after mouse hover for active subaward
    ...
    When I click on "Save" in the page details
    Then I softly see the following messages in the page details contains:
      | To Save, Purpose is required in the Overview tab under the Plan section. |
...
#      """
  ...
  @66219 @validateInstructionField @ErrorMsgTest
  Scenario: To verify that if instruction field is left unfilled in site visit review and upon clicking on the save button by the award owner (Pm profile) on the top right corner of the page validation error must be throw
    ...
    Then I see the following messages in the page details contains:
      | To Save, Instructions for Subrecipient is required in the Overview tab under the Instructions section. |
  ...
  @66416 @validateSourceInDeskReview @ErrorMsgTest
  ...
  @66410 @validateInstructionFieldInDeskReview @ErrorMsgTest
...
#      | Construction    | 1000         | 100        | 100            |
  ...
  | Verify that user is able to see approved tasks in Completed tasks listing of the grants post subaward approved by Fiscal Officer
    ...
    When I enter "Edition_StandAlone" values from "Award_Field_Values.xlsx"
    And I navigate to "Budget" sub tab
    And I enter value "15" into field "BudgetRedirectionThreshhold__c"
    And I click on "Save" in the page details
    And I navigate to "Budget" sub tab
    When I click on top right button "Associate" in flex table with id "---subAwardStandAlone:-:fundingAccountsTableId---"
    When I perform quick search for "Automation Permanent Funding Account" in "---subAwardStandAlone:-:awardFundingAccountsTableId---" panel
  ...
  Scenario Outline: Validate that 'Amount Awarded' ($) value doesn't  get changed on the Grant post Grant is closed
    ...
    When I navigate to "Grants" content inside "Grants, Subawards & Amendments" subheader on left panel
    And I click toggle button to select "Grants - Closed"
    When I perform quick search for "<Award Name>" in "---subAwardFromFDM:-:grantsTableId---" panel
    When I click on "View" icon for "<Award Name>" inside flex table with id "---subAwardFromFDM:-:grantsTableId---" without waiting for record
    And I navigate to "Budget" sub tab
    Then I softly see field "Cumulative Obligation" as "{SavedValue:CumulativeObligation}"
    When I re-login to "Grantor" app as "PM" user on "INTERNAL" portal
    And I navigate to "Grants" tab
    When I navigate to "Grants" content inside "Grants, Subawards & Amendments" subheader on left panel
    And I click toggle button to select "Grants - Closed"
    When I perform quick search for "<Award Name>" in "---subAwardFromFDM:-:grantsTableId---" panel
    Then I softly see value "Closed/Completed" for title "Status" inside table "---subAwardFromFDM:-:grantsTableId---"
  ...
  Scenario:  Verify that other internal users of organization(ex-Community Health & Equity) are not able to view draft grants with the different organization(Ex-Test Automation Organization).
    And I activated standalone subaward "Automation Runtime Award" with properties "default" of type "Competitive"
    When I login to "Grantor" app as "Sarah PM" user
    And I navigate to "Grants" tab
    When I navigate to "Grants" content inside "Grants, Subawards & Amendments" subheader on left panel
    And I click toggle button to select "Grants - All"
    When I perform quick search for "{SavedValue:Automation Runtime Award}" in "---subAwardStandAlone:-:activeGrantsTableId---" panel
  ...
  Scenario:Validate that Total mandatory terms and condition in master table of planning and that associated in the Subaward Terms and condition table is same
    ...
    When I perform quick search for "Terms" in "---home:-:termsAndConditionsTableId---" panel
  ...
  @66938 @doNotSeeSubawardButtonAfterRejectingByEXE  @smoke
...
#    When I expand nested table containing column value "<Application Name>"
    ...
    When I click on "Start" icon for "Record Id" inside flex table with id "---applicationReview:-:pendingTaskTableId---" without waiting for record
...
#    And I select value "Victor EXE" into field "input-2"
  ...
  Scenario: Validate EXE user should have two options if user click on Classification in Upload File from Computer Template for Grant Others
    ...
    Then I see only the following ordered options in dropdown field "Classification" :
      | Select file classification | Template for Grant | Others |
  ...
  Scenario: Validate Reassignment Task all simultaneous reassignment task ownership should reassigned to new owner
    ...
    And I re-login to "Grantor" app as "EXE1" user on "INTERNAL" portal
    ...
    When I navigate to "Responsibilities" sub tab
    When I click on "Enter Review" icon for "{SavedValue:EXE1 Username}" inside flex table with id "---deskreview:-:reviewersFlexTableId---"
...
#    When I close "Site Visit Reviewers" modal by clicking the top right x button
  ...
  Scenario: Validate Award failure and success email should generated for approvers and for peer reviewers
    ...
    Then I see the mail text is as follows :
      ...
      EGMS ID Type Status Subject Assigned By Reason of Failure
      {SavedValue:AwardEGMSID1} Review Grantor Announcement Not Started Review Announcement #{SavedValue:AwardEGMSID1} Created for Program #{SavedValue:ProgramEGMSID} Automation FO Responsibilities Tab - A person with the same role cannot be added again.
    ...
    Then I see the mail text is as follows :
      ...
      EGMS ID Type Status Subject Assigned By Reason of Failure
      {SavedValue:AwardEGMSID2} Review Grantor Announcement Not Started Review Announcement #{SavedValue:AwardEGMSID1} Created for Program #{SavedValue:ProgramEGMSID} Automation FO Responsibilities Tab - A person with the same role cannot be added again.
    ...
    Then I see the mail text is as follows :
      ...
      EGMS ID Type Status Subject Assigned By Reason of Failure
      {SavedValue:AwardEGMSID3} Review Grantor Announcement Not Started Review Announcement #{SavedValue:AwardEGMSID1} Created for Program #{SavedValue:ProgramEGMSID} Automation FO Responsibilities Tab - A person with the same role cannot be added again.
  ...
  Scenario:Verify PM user can not see a Focus area with zero value for New Obligation and Cumulative Obligation column on the award created from FDM
    ...
    And I navigate to "Budget" sub tab
    Then I softly see value "Automation Permanent Focus Area2" for title "Title" inside table "---subAwardStandAlone:-:focusAreaTableId---"
    Then I softly see value "$0.00" for title "Budgeted Amount" against the value "Automation Permanent Focus Area2" inside table "---subAwardStandAlone:-:focusAreaTableId---"
...
#    And I click modal button "Close"
  ...
  @53911 @66200 @67817 @66318 @68036 @69318 @ValidateAdvancePaymentRequestcreation
  Scenario Outline: Advance Payment Request creation when Advance Payment Allowed selected as Yes
    ...
    And I enter "GrantFields1" values from "Award_Field_Values.xlsx"
    And I click modal button "Continue"
    And I enter "Grant_Edition_Comp_Focus_No" values from "Award_Field_Values.xlsx"
    When I click modal button "Save and Continue"
    And I navigate to "Subawards" sub tab
    And I click on "View" icon for "Created" inside flex table with id "---subAwardStandAlone:-:subawardsTableId---" without waiting for record
    And I get the "EGMS ID"
...
#      | Automation Permanent Focus Area | 0          | 3650     |
    ...
    And I refresh the page
    And I wait for "2" seconds
    Then I softly see snapshot with name containing "Subaward Send_to_Subrecipient.pdf" as name
    And I re-login to "Grants Portal" app as "SPI3" user on "SUBPORTAL" portal
    When I navigate to "Grants" tab
    When I navigate to "Pending Tasks" content inside "My Tasks" subheader on left panel
    And I perform quick search for "Record Id" in "---subAwardStandAlone:-:pendingTaskTableId---" panel
    ...
    And I refresh the page
    And I wait for "2" seconds
    Then I softly see snapshot with name containing "Award_Accepted.pdf" as name
    When I re-login to "Grantor" app as "dynamicUser" user on "INTERNAL" portal
    And I navigate to "Grants" tab
    When I navigate to "Grants" content inside "Grants, Subawards & Amendments" subheader on left panel
    And I click toggle button to select "Grants - All"
    ...
    And I navigate to "Budget" sub tab
    And I wait for "2" seconds
    Then I see value "$1,000.00" for title "Encumbrance" against the value "{SavedValue:fundingAccount}" inside table "---subAwardStandAlone:-:fundingAccountsTableId---"
    And I click on "Submit for Approval" in the page details
    And I navigate to "History" sub tab
    ...
    And I refresh the page
    And I wait for "2" seconds
    Then I softly see snapshot with name containing "Accepted_After_Approval.pdf" as name
    When I re-login to "Grantor" app as "dynamicUser" user on "INTERNAL" portal
    And I navigate to "Grants" tab
    When I navigate to "Grants" content inside "Grants, Subawards & Amendments" subheader on left panel
    And I click toggle button to select "Grants - All"
    ...
    When I navigate to "Grants" content inside "Grants, Subawards & Amendments" subheader on left panel
    And I click toggle button to select "Grants - Active"
    And I perform quick search for "<Award Name>" in "---paymentRequest:-:recipientGrantTableId---" panel
    Then I see value "{SavedValue:AwardEGMSID}" for title "Active Subaward" against the value "<Grant Name>" inside table "---paymentRequest:-:recipientGrantTableId---"
    When I navigate to "Subawards" content inside "Grants, Subawards & Amendments" subheader on left panel
    And I perform quick search for "<Award Name>" in "---paymentRequest:-:recipientsSubawardTableId---" panel
    And I click on "View" icon for "<Award Name>" inside flex table with id "---paymentRequest:-:recipientsSubawardTableId---" without waiting for record
    And I navigate to "History" sub tab
  ...
  @543809 @ValidateDirectedGrantValidatethatdefaultThresholdvalueshouldbeUpdateonAward
  Scenario: Validate Directed Grant that default Threshold value should be Update on Award
    When I login to "Grantor" app as "EXE" user
    And I navigate to "Grants" tab
    When I navigate to "Grants" content inside "Grants, Subawards & Amendments" subheader on left panel
    And I click on top right button "New" in flex table with id "---subAwardStandAlone:-:activeGrantsTableId---"
    ...
    And I click on "View" icon for "Created" inside flex table with id "---subAwardStandAlone:-:subawardsTableId---" without waiting for record
    And I navigate to "Budget" sub tab
    Then I softly see field "Budget Redirection Threshold %" as "0.00%" in "Budget Summary" pageblock
    And I click on "Edit" in the page details
    Then I softly see fields "BudgetRedirectionThreshhold__c" is in edit mode

  @543810 @ValidatethatBudgetRedirectionThresholdfieldisnoteditableonceSendtoSRstate
  Scenario: Validate that Budget Redirection Threshold field is not editable once Send to SR state
    When I login to "Grantor" app as "PM" user
    And I navigate to "Grants" tab
    When I navigate to "Grants" content inside "Grants, Subawards & Amendments" subheader on left panel
    And I click on top right button "New" in flex table with id "---subAwardStandAlone:-:activeGrantsTableId---"
    ...
    And I navigate to "Budget" sub tab
    Then I softly see that "Budget Redirection Threshold %" rendered in view mode only
    Then I softly see field "Budget Redirection Threshold %" as "10.00%" in "Budget Summary" pageblock

  @543812 @ValidateThresholdfieldshouldnoteditabletononAwardOwner
  Scenario: Validate Threshold field should not editable to non Award Owner
    When I login to "Grantor" app as "PM" user
    And I navigate to "Grants" tab
    When I navigate to "Grants" content inside "Grants, Subawards & Amendments" subheader on left panel
    And I click on top right button "New" in flex table with id "---subAwardStandAlone:-:activeGrantsTableId---"
  ...
  @543818 @543825 @ValidateErrorMessageforExceedingBudgetRedirectionThresholdonAward
  Scenario: Validate Error Message for Exceeding Budget Redirection Threshold on Award
    When I login to "Grantor" app as "EXE" user
    And I navigate to "Grants" tab
    When I navigate to "Grants" content inside "Grants, Subawards & Amendments" subheader on left panel
    And I click on top right button "New" in flex table with id "---subAwardStandAlone:-:activeGrantsTableId---"
    ...
    And I click on "Edit" in the page details
    When I enter "Edition_StandAlone" values from "Award_Field_Values.xlsx"
    And I enter value "120" into field "BudgetRedirectionThreshhold__c"
    And I click on "Save" in the page details
    And I wait for "2" seconds
    And I click on "Submit for Approval" in the page details
    And I wait for "2" seconds
    Then I softly see the following messages in the page details contains:
      | Budget Redirection Threshold must be between 0% and 100%. Please enter a valid value. |

  @543831 @ValidateBudgetRedirectionThresholdFieldHiddenonGrantLayout
  Scenario: Validate Budget Redirection Threshold % Field Hidden on Grant Layout
    When I login to "Grantor" app as "EXE" user
    And I navigate to "Grants" tab
    When I navigate to "Grants" content inside "Grants, Subawards & Amendments" subheader on left panel
    And I click on top right button "New" in flex table with id "---subAwardStandAlone:-:activeGrantsTableId---"
    ...
    And I click modal button "Continue"
    And I wait for "2" seconds
    Then I softly cannot see field on modal "Budget Redirection Threshold (%)" inside page block

  @543817 @ValidateOverrideofBudgetRedirectionThresholdatAwardLevel
  Scenario Outline: Validate Override of Budget Redirection Threshold at Award Level
    And I published "Competitive" type announcement having name "Automation Runtime Announcement Application Review" and properties "NO_RISK_ASSESSMENT-Automation EXE user"
    And I initiated an application review for application "{SavedValue:Automation Runtime Announcement Application Review}" on announcement "{SavedValue:Automation Runtime Announcement Application Review}" with properties "default"
    And I login to "Grantor" app as "EXE" user
    When I navigate to "Applications" tab
    And I navigate to "Applications" content inside "Applications" subheader on left panel
    ...
    When I enter values into fields
      ...
      | AuGr                        | GrantCode__c     |
      | Automation Test Description | Justification__c |
    When I enter value "10" into field "BudgetRedirectionThreshhold__c"
    And I click on "Save" in the page details
    And I wait for "2" seconds
    ...
    And I navigate to "Budget" sub tab
    Then I softly see fields "BudgetRedirectionThreshhold__c" is in edit mode
    When I enter value "20" into field "BudgetRedirectionThreshhold__c"
    And I click on "Save" in the page details
    And I navigate to "Budget" sub tab
    And I wait for "2" seconds
    Then I softly see field "Budget Redirection Threshold %" as "20.00%"
