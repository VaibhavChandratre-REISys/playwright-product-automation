@siteVisits @SiteVisitExecution @grantor-regression @grantor-parallel-regression @siteVisit @regression @siteVisit_Lwc_Run @siteAndDeskReview @siteExecution
Feature: Validate all scenarios in the Site Visit
  ...
  @51084 @66229 @66232 @51085 @51086 @66283 @75869 @notifyPendingTaskForSubrecipientSiteVisit @smoke
...
#    And I collapse nested table containing column value "Automation Finding"
  ...
  @60833 @theSnapshotAfterSiteVisitsIsSendToSubrecipient @snapExecution
  ...
  @60832 @65385 @75868 @theSnapshotAfterSubmitForApproval @snapExecution
