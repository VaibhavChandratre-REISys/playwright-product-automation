@siteVisits @organizationalSiteVisit @grantor-regression @grantor-parallel-regression @siteVisit @regression @siteVisit_Lwc_Run @siteAndDeskReview @siteExecution
...
#    And I collapse nested table containing column value "Automation Finding"
  ...
  @55799 @organizationalsiteVisitPurpose @ErrorMsgTest
  ...
  @55800 @organizationalsiteVisitSource @ErrorMsgTest
...
#    And I click modal button "Close"
  ...
  Scenario: Validate whether other than record owner Fo user can delete the created Org Level Site Visit
    ...
    Then I softly see value "Record Id" for title "EGMS ID" inside table "SiteVisit"
    Then I cannot see row level action button "Delete" against "Record Id" in flex table with id "SiteVisit"
    Then I cannot see row level action button "Edit" against "Record Id" in flex table with id "SiteVisit"
