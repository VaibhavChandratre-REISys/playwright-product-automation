@preApplicationExecution1 @preAplicationWB @grantor-regression @grantor-parallel-regression @app @ApplicationAndPre-App
Feature: Pre-Application scenarios without background
  ...
  Scenario: Validate the attachment checklist of the PreApplication
    ...
    When I click on "Attach" icon for "Optional" inside flex table with id "---preApplication:-:preApplicationChecklistId---" without waiting for record
  ...
  @72575 @70253 @75595 @spaUserCannotSubmitanPre-application
  ...
  Validate whether users from other organizations will be able to create Pre-Applications
    ...
    Then I softly see the following messages in the page details contains:
      | Pre-Application Title is required to save. |
...
#    And I click on "Back" in the page details
 ...
 @72516 @72518 @34154 @72519 @72520 @72515 @preapplicationInformationCopiedToApplication  @buglogged100926 @buglogged109204 @buglogged169487
  ...
  Validate other than record Owner Pm , other users will not be to Accept submitted Pre-Application
    ...
    #And I save the field labeled "Match Required?" as "matchrequired"
    When I navigate to "Forms and Files" sub tab
...
#   And I click on "Back" in the page details
  ...
  @34156 @75962 @75963 @75964 @preAppHistoryFieldGetUdated  @skipOnJenkins
...
#   And I click on "Back" in the page details
  ...
  @77656 @snapshotHistoryPreApplication
...
#   Added below extra steps due to bug once resolved remove the step
  ...
  @174890 @ValidateDueDatefieldshouldbeRequiredtosubmitunderNegotiationRequestdetailssectiononGrantorSide @sprint-8
...
#   And I click on "Back" in the page details
  ...
  @174900 @174903 @ValidateExplanationofnegotiationneededfieldshouldbeRequairedtosubmitunderNegotiationRequestdetailssectiononGrantorSide @sprint-8
...
#    And I click on "Back" in the page details
  ...
  Scenario: Validate user should able to see the changes after feeling the format grantor & Subrecipient side
    ...
    And I switch to tab number "1"
    And I wait for "3" seconds
    Then I softly see field "1a. Describe the activities and/or services to be provided. (10 points)" as "Automation Test" in "Project Characteristics" pageblock
    Then I softly see field "1b. Describe how the project will be completed within the required 24-month timeline. (10 points)" as "Automation Test" in "Project Characteristics" pageblock
    Then I softly see field "1a. Organizational capacity. (10 points)" as "9"
    Then I softly see field "1b. Experience Level. (10 points)" as "0-5 years"
...
#    And I click on "Back" in the page details
  ...
  @ValidatePre-appnewownerpeerreviewershouldabletosubmitthereviewcommentsforpre-app @sprint-11-US-218319  @reassignment
