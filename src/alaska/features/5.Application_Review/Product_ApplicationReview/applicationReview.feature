@AppReview @applicationReviewWithouBg @grantor-regression @grantor-parallel-regression @app @regression @applicationReviewTBE
...
#    When I expand nested table containing column value "<Application Name>"
 ...
 @79201 @79204 @numberOfreviewersAndDeleteReviewers
  ...
  Scenario Outline: To verify user able to download pdf for Review Steps section in related log tab of Apllication phase.
    ...
    Then I softly see "Review" on page "1" of "govgrants" pdf file
    Examples:
      | Announcement Name                                               |
      | {SavedValue:Automation Runtime Announcement Application Review} |
...
#    When I expand nested table containing column value "<Application Name>"
  ...
  @79978 @ValidatingSuccessMessagePromoteNextButtonPreScreenReviewStepForm
...
#    When I expand nested table containing column value "<Application Name>"
  ...
  @80060 @verifyErrorMessageForSubAwardAbbreviation
...
#    When I expand nested table containing column value "<Application Name>"
    ...
    And I click on "Save" in the page details
    Then I see the following messages in the page details :
      | Subaward Abbreviation is required to save under Funding Decision Memo. |
...
#    When I expand nested table containing column value "<Application Name>"
    ...
    #79672
    And I wait for "2" seconds
    Then I softly see field in the form "Comments" as ""
