@closeoutNysed
Feature: Validate all scenarios in Closeout from FDM

  @489031 @VerifythattheInternalUserdoesnotseethequestionLeverageAllowedontheCloseoutLayout @Sprint-00 @US-487276
  Scenario Outline: Verify that the Internal User does not see the question "Leverage Allowed?" on the Closeout Layout.
    Given I published "Competitive" type announcement having name "Automation Runtime FDM Announcement" and properties "default-<User>"
...
#      | ADMIN    | Automation ADMIN user |
  ...
  @491266 @VerifythattheSubrecipientUserdoesnotseetheLeverageAllowed?ontheCloseoutLayout @Sprint-01 @US-487975
...
#      | SPA      |
  ...
  @493287 @493289 @493293 @493297 @493298 @VerifythattheInternaluserdoseeEditbuttonattheCloseoutRequestpagelayoutandcanseeotherrecordflowactionbuttonsatpagelevelactiondropdownCreatedCloseoutRequest @Sprint-01 @US-490341
