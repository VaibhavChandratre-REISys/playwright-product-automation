@grantAndAward @grantor-regression @grantor-parallel-regression @regression @AwardExecutionStandAalone
Feature: Validate all scenarios in the Stand Alone Award and Grant
  ...
  Scenario Outline: Associate a Key Contact
    ...
    Then I softly see the following messages in the page details contains:
      | Saved Successfully! |
    Then I softly see that "Automation SPA" has been added in flextable with Id "---subAwardStandAlone:-:associatedContactsTableId---"
    Examples:
      | Contact        |
      | Automation SPA |
...
#    And I enter "Risk Assessment Creation" values from "Award_Field_Values.xlsx"
  ...
  Scenario Outline: Validate the award send to recipient and acceptance by recipient before approval
    ...
    Then I softly see the following messages in the page details contains:
     #| All mandatory terms & conditions within Project Period are already associated. |
...
#    Then I softly see initial budget balance "{SavedValue:award available balance after deduction}" is decreased by "1000" and is matched with current budget balance "{SavedValue:award available balance after deduction}"
  ...
  @NeedtoCheckraisedwithBug @53911 @66200 @67817 @66318 @68036 @69318 @ValidateAdvancePaymentRequestcreation  @buglogged102071
  Scenario Outline: Advance Payment Request creation when Advance Payment Allowed selected as Yes
    ...
    Then I softly see value "{SavedValue:SPI1 Username}" for title "Taken By" against the value "Award_Accepted.pdf" inside table "---subAwardStandAlone:-:snapshotHistoryTableId---"
    When I re-login to "As a Grantor" app as "dynamicUser" user on "INTERNAL" portal
    And I navigate to "Grants" tab
    When I navigate to "Grants" content inside "Grants, Subawards & Amendments" subheader on left panel
    And I click toggle button to select "Grants - All"
    ...
    Then I softly see value "{SavedValue:SPI1 Username}" for title "Taken By" against the value "Accepted_After_Approval.pdf" inside table "---subAwardStandAlone:-:snapshotHistoryTableId---"
    When I re-login to "As a Grantor" app as "dynamicUser" user on "INTERNAL" portal
    And I navigate to "Grants" tab
    When I navigate to "Grants" content inside "Grants, Subawards & Amendments" subheader on left panel
    And I click toggle button to select "Grants - All"
  ...
  @66087 @UnableToActivateSubAwardIfRiskAssesmentApprovePMHasNotApprovedIt  @buglogged127848
  ...
  Scenario Outline: To verify that approver of ( SPI/SPA) cannot be added in Program approver in Responsibility tab by the award owner for Award approval
    ...
    Then I do not see value "{SavedValue:SPI1 Username}" inside auto search result after enterring into field "name__r.name"
...
#    And I switch to iframe with id "---subAwardStandAlone:-:termsndConditionsTableId---"
...
#    Then I softly see field "Description" as "Updated Automation Description"
...
#    And I see value "Created" for title "Status" inside table "---subAwardFromFDM:-:RecipientSubAwardTableId---"
  ...
  @65970 @validateSendBackTOpmbyFO  @Re-RunStandAlone
