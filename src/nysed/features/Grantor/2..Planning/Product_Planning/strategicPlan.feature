@strategicPlan @planning @productplanning
...
#    Then I softly see field "Description" as "Execution Strategic Objective"
  ...
  @195263 @195290 @ValidatePMuserrecordownercanEdit/DeletefilesonStrategicGoalifuserhaseditaccessonmaineditbuttonforStrategicGoalisinDraftstate @addFiles @exclude
