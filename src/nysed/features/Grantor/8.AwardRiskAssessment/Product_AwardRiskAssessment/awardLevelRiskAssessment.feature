...
#      | Subaward Risk Assessment for {SavedValue:RiskId} has been Assigned for Program Approval |
  ...
  @77659 @58167 @59625 @66378 @PendingTaskCreationAndapprovalProcessofRiskAssessment @skipOnJenkins @FieldHistoryExclude
  ...
  @58936 @acknowledgementIsRequiredToContinue
  ...
  @60208 @validateRecordOwnerISAbleToViewRASnapshot  @skipOnJenkins
  ...
  @60209 @validateRecordOwnerISAbleToViewActiveRASnapshot
...
#    And I click on "Send for Review" icon for "Automation FO1" inside flex table with id "---riskassessment:-:raPeerReviewFlexTableId---" without waiting for record
  ...
  @223375 @ValidateRiskAssessmentModuleusershouldabletoreassignthetasktonewuserofmorethan10records&1emailshouldbetriggeredforallrecords @sprint-10-US-205576  @reassignment @wip
