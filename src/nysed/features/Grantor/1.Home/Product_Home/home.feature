...
Feature: Validate all scenarios in the home tab
  ...
  Scenario: Validate whether all7 users have view access to Internal Organization
    ...
    Then I softly can see row level action button "View" against "GMS Administrator" in flex table with id "---home:-:internalOrganizationId---"
  ...
  @56712 @56713 @activeINDandsubrecipientOrganizationView @wip
  Scenario Outline: Validate whether all users have view access to Subrecipient Organization and Active Individual Subrecipients
    ...
    When I perform quick search for "Automation Permanent Subrecipient Org" in "---home:-:subrecipientActiveAccountId---" panel
    And I click on "View" icon for "Automation Permanent Subrecipient Org" inside flex table with id "---home:-:subrecipientActiveAccountId---" without waiting for record
  ...
  @56715 @56714 @activeIndividualSubrecipientsEdit @wip
  Scenario Outline: Validate whether ADMIN/DA have Edit access to Active Individual Subrecipients and Subrecipient Organizations
    ...
    And I navigate to "Approved Subrecipient Organizations" content inside "Organization" subheader on left panel
    When I perform quick search for "Automation Permanent Subrecipient Org" in "---home:-:subrecipientActiveAccountId---" panel
    Then I softly can see row level action button "Edit" against "Automation Permanent Subrecipient Org" in flex table with id "---home:-:subrecipientActiveAccountId---"
    When I perform quick search for "{user:OldfullName}" in "---home:-:indActiveAccountId---" panel
...
#    And I save the contact name as "Automation Runtime Contact"
    ...
    Then I softly see field "Organization" as "GMS Administrator"
    When I navigate to "Home" tab
    And I navigate to "Internal" content inside "Contacts" subheader on left panel
    When I perform quick search for "{SavedValue:Automation Runtime Contact} Contact" in "---home:-:internalContactTableId---" panel
  ...
  Scenario Outline: Verifying all Internal Users has View access to SME Reviewers Contact
    ...
    When I click modal button "Save"
    And I wait for "2" seconds
    When I perform quick search for "{SavedValue:Automation Runtime Contact} Contact" in "---home:-:reviewersTableId---" panel
    Then I see value "{SavedValue:Automation Runtime Contact} Contact" for title "Full Name" inside table "---home:-:reviewersTableId---"
    Then I see value "New" for title "Status" inside table "---home:-:reviewersTableId---"
    When I perform quick search for "{SavedValue:Automation Runtime Contact} Contact" in "---home:-:reviewersTableId---" panel
    Then I softly can see row level action button "View" against "{SavedValue:Automation Runtime Contact} Contact" in flex table with id "---home:-:reviewersTableId---"
  ...
  Scenario Outline: Verify the system allows all Internal users to Send Invitation to SME Reviewer
    ...
    And I wait for "2" seconds
    And I navigate to "SME Reviewers" content inside "Contacts" subheader on left panel
    And I perform quick search for "{SavedValue:Automation Runtime Contact} Contact" in "---home:-:reviewersTableId---" panel
    And I click on "Send Invitation" icon for "{SavedValue:Automation Runtime Contact} Contact" inside flex table with id "---home:-:reviewersTableId---" without waiting for record
  ...
  Scenario Outline: Verify that system allows user to see the detail page of Active SME Reviewer contact
    ...
    And I navigate to "SME Reviewers" content inside "Contacts" subheader on left panel
    When I perform quick search for "{SavedValue:Automation Runtime Contact} Contact" in "---home:-:reviewersTableId---" panel
    Then I can see row level action button "View" against "{SavedValue:Automation Runtime Contact} Contact" in flex table with id "---home:-:reviewersTableId---"
    Given I delete the record "{SavedValue:Automation Runtime Contact} Contact" from the object "CONTACT"
    Examples:
      | User  |
      | ADMIN |
  ...
  Scenario Outline: Validate whether ADMIN and DA users can Edit the Subrecipient Organization
    ...
    When I navigate to "Home" tab
    When I navigate to "Approved Subrecipient Organizations" content inside "Organization" subheader on left panel
    And I perform quick search for "Automation Permanent Subrecipient Org" in "---home:-:subrecipientActiveAccountId---" panel
    And I wait for "5" seconds
    When I click on "Edit" icon for "Automation Permanent Subrecipient Org" inside flex table with id "---home:-:subrecipientActiveAccountId---" without waiting for record
    #Bug441314
 ...
 @56733 @internalContactsEdition @smoke
  Scenario Outline: Validate whether all Internal Users can edit the Contacts
   ...
   And I save the value from row "1" for column name "Name" as "Automation Runtime Contact" from flex table "---home:-:internalContactTableId---"
   Then I can see row level action button "Edit" against "{SavedValue:Automation Runtime Contact}" in flex table with id "---home:-:internalContactTableId---"
    Examples:
      | User  |
      | ADMIN |
      | EXE   |
  ...
  Scenario Outline: Verifying all Internal Users has Edit access to SME Contact
    ...
    And I wait for "3" seconds
    And I perform quick search for "{SavedValue:Automation Runtime Contact} Contact" in "---home:-:reviewersTableId---" panel
    When I click on "Edit" icon for "{SavedValue:Automation Runtime Contact} Contact" inside flex table with id "---home:-:reviewersTableId---" without waiting for record
    And I click modal button "Save"
    And I wait for "2" seconds
    Then I see value "New" for title "Status" inside table "---home:-:reviewersTableId---"
  ...
  Scenario: Validate whether ADMIN can Create and Edition of Additional Addresses
    ...
    And I click modal button "Save"
    Then I softly see that "GMS Administrator" is in "Active" status
  ...
  Scenario Outline: Validate whether Users with Admin/ PM profiles can edit their own organizations and Internal organization page has Header
    ...
    Then I softly can see row level action button "Edit" against "GMS Administrator" in flex table with id "---home:-:internalOrganizationId---"
    #56912
    When I click on "Edit" icon for "GMS Administrator" inside table without waiting for record
  ...
  Scenario Outline: Verifying if the Internal Users has Edit access to Subrecipient Contact
    ...
    And I navigate to "Approved Subrecipient Organizations" content inside "Organization" subheader on left panel
    When I perform quick search for "Automation Permanent Subrecipient Org" in "---home:-:subrecipientActiveAccountId---" panel
    When I click on "View" icon for "Automation Permanent Subrecipient Org" inside table without waiting for record
  ...
  Scenario Outline: Verify system allows access to all Internal users to view the List page
    ...
    Then I softly see "Agency Abbreviation" in flex table header "---home:-:internalOrganizationId---"
    Then I softly see "Account Type" in flex table header "---home:-:internalOrganizationId---"
  ...
  Scenario Outline: Verify whether an Agency belongs to only one Parent
    ...
    When I navigate to "Home" tab
    And I navigate to "Internal" content inside "Organization" subheader on left panel
    Then I see values "GMS Administrator" and "Agency" inside table
    Examples:
      | User  |
      | ADMIN |

  @57343 @individualSubrecipientContactCreation @buglogged138607 @wip
  ...
  Scenario Outline: Verify all profiles users should be able to view the Submitted Applications and Active Grants.
    ...
    When I navigate to "Approved Subrecipient Organizations" content inside "Organization" subheader on left panel
    When I perform quick search for "Automation Permanent Subrecipient Org" in "---home:-:subrecipientActiveAccountId---" panel
    When I click on "View" icon for "Automation Permanent Subrecipient Org" inside flex table with id "---home:-:subrecipientActiveAccountId---" without waiting for record
 ...
 @57349 @viewActiveIndividualOrganizations @wip
  ...
  Scenario Outline: Verify whether the Overview Tab has the sections: Related Contacts and Indirect rates
    ...
    When I navigate to "Home" tab
    And I navigate to "Internal" content inside "Organization" subheader on left panel
    When I click on "View" icon for "GMS Administrator" inside flex table with id "---home:-:internalOrganizationId---" with wait for record
  ...
  @62104 @indProfileEditAccess @wip
  ...
  @62105 @externalUserhomePendingTask @wip
 ...
 @62106 @indUserEditProfile @wip
  ...
  @62912 @VerifyrecentlyViewedRecordAndDetailsOnMiniPageLayoutAndHoverLink
  Scenario: The Internal User should be able to view the recently viewed record and details on the Mini pagelayout and the hover link  will take to the record
    ...
    When I click on "View" icon for "GMS Administrator" inside table without waiting for record
    When I navigate to "Planning" tab
    And I mouse hover to link contains "GMS Administrator"
    Then I softly see page title contains as "GMS Administrator"
  ...
  Scenario: To verify internal user able to Create new SME reviewer
    ...
    And I wait for "5" seconds
    And I perform quick search for "{SavedValue:Automation Runtime Contact} Contact" in "---home:-:reviewersTableId---" panel
    Then I softly see value "{SavedValue:Automation Runtime Contact} Contact" for title "Full Name" inside table "---home:-:reviewersTableId---"
