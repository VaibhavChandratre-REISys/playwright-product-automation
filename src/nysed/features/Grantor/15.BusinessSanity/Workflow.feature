...
Feature: Validate all scenarios of every modules flow
  ...
  @programFlow @ValidateFullProgramFlow
  Scenario: Validate Full Program Flow
  ...
  Scenario: Verify Subrecipient Organization Registration Process
    Given I begin "Organization" registration
  ...
  Scenario: Testing xss
    ...
    And I send the email under collab tab with following details:
      | To                        | Cc                         | Subject | Body            |
      | pm.automation@yopmail.com | exe.automation@yopmail.com | test    | Automation Test |
    Then I see the text "Email Sent Successfully." in modal

  @InternalUserPasswordcheckScriptForProdCopy
  ...
  @ExternalUserPasswordcheckScript
  Scenario Outline: test
    Given I am on "SUBPORTAL" portal
  ...
  Scenario Outline:Verify that Internal Profile User see "Scope of Work Change" Type is Hidden on Create Amendment Request Modal
    ...
    Given I published "Competitive" type announcement having name "Automation Runtime FDM Grant" for the activated program "{SavedValue:Automation Runtime Active Program}" with properties "default"
  ...
  @DirectedAnnouncementAPI
  Scenario Outline:Verify that Internal Profile User see "Scope of Work Change" Type is Hidden on Create Amendment Request Modal
    Given I activate the internal program "Automation Runtime Active Program" with properties "default"
    Given I published "Directed" type announcement having name "Automation Runtime FDM Grant" for the activated program "{SavedValue:Automation Runtime Active Program}" with properties "default"
    And I initiated an application review for application "<GrantName>" on announcement "<GrantName>" with properties "default"
    Given I Completed review step ProgramAndGrantFinanceReview from Initiated Application Review Application "<GrantName>"
    And I created approved FDM on application "<GrantName>"
    Given I created award from approved FDM with announcement "<GrantName>"
  ...
  @FormulaAnnouncementBY_APPLICANT_FOCUS_AREA_API
  Scenario Outline:Verify that Internal Profile User see "Scope of Work Change" Type is Hidden on Create Amendment Request Modal
    Given I activate the internal program "Automation Runtime Active Program" with properties "default"
  ...
  @FormulaAnnouncementBY_APPLICANT_API
  Scenario Outline:Verify that Internal Profile User see "Scope of Work Change" Type is Hidden on Create Amendment Request Modal
    Given I activate the internal program "Automation Runtime Active Program" with properties "default"
    Given I published "Formula" type announcement having name "Automation Runtime FDM Grant" for the activated program "{SavedValue:Automation Runtime Active Program}" with properties "BY_APPLICANT"
    And I initiated an application review for application "<GrantName>" on announcement "<GrantName>" with properties "default"
  ...
  @DirectGrant_FormulaAnnouncement_BY_APPLICANT_API
  Scenario Outline: Direct Grant API for Formula Announcement with BY_APPLICANT property
    Given I activate the internal program "Automation Runtime Active Program" with properties "default"
  ...
  @DirectGrant_BudgetCategoryforFS10F
  Scenario Outline: Direct Grant API for Formula Announcement with BY_APPLICANT property
    Given I activate the internal program "Automation Runtime Active Program" with properties "default"
    Given I published "Formula" type announcement having name "Automation Runtime Announcement Direct Grant" for the activated program "{SavedValue:Automation Runtime Active Program}" with properties "DIRECT_GRANT_YES_BA"
    Given I created standalone grant from approved announcement with announcement "<GrantName>" and properties "default"
